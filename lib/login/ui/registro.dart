      ...
      SingleChildScrollView(
        ...
        decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color.fromARGB(255, 218, 144, 95), Color.fromARGB(255, 227, 113, 13)], // Colores del degradado
                  begin: Alignment.centerLeft, // Inicio del degradado a la izquierda
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
                BoxShadow(
                  color: const Color.fromARGB(255, 42, 9, 9), // Color de la sombra
          ...
          child: Form(
             ...
             children: <Widget>[
              ...
              Container(child: Image.network("https://upload.wikimedia.org/wikipedia/commons/b/bc/Unifranz.png", height: 200.0,width: 200.0,),
              decoration: BoxDecoration(
                color: Colors.black87,  
              ),
                  ...
                  onPressed: () async {
                    ...
                    if (_passController.text==_ConfirmpassController.text) {
                      if(_formKey.currentState!.validate()) {
                        bool respuesta = await UsersUtilidades().saveUsers(
